...
\restrict 49Xbn50iUtaqUpsCqD8QJdjcXhqpAo6TxSLUMH0iCZnQqPC0Z2d2ZQfhG6woEc8
...
--
-- Data for Name: ascents; Type: TABLE DATA; Schema: public; Owner: postgres
--

COPY public.ascents (id, mountain_id, group_id, date, status, notes) FROM stdin;
\.


--
-- Data for Name: climbers; Type: TABLE DATA; Schema: public; Owner: postgres
--

COPY public.climbers (id, name, experience, nationality) FROM stdin;
\.
...
COPY public.equipment (id, name, equipment_type, condition, purchase_date) FROM stdin;
1	Верёвка динамическая 60м	Страховочное	Новое	2025-11-20
2	Каска Petzl	Защита	Отличное	2025-10-15
\.


--
-- Data for Name: group_climbers; Type: TABLE DATA; Schema: public; Owner: postgres
--

COPY public.group_climbers (group_id, climber_id) FROM stdin;
\.
...
COPY public.groups (id, name, formation_date) FROM stdin;
\.
...
COPY public.mountains (id, name, height, location, difficulty, created_at, elevation) FROM stdin;
1	Гора Тест Алембик	4500	Тестовые Альпы	Высокая	2025-11-20 17:33:34.372878	\N
\.


--
-- Name: ascents_id_seq; Type: SEQUENCE SET; Schema: public; Owner: postgres
--

SELECT pg_catalog.setval('public.ascents_id_seq', 1, false);


--
-- Name: climbers_id_seq; Type: SEQUENCE SET; Schema: public; Owner: postgres
--

SELECT pg_catalog.setval('public.climbers_id_seq', 1, false);
...
SELECT pg_catalog.setval('public.mountains_id_seq', 1, true);
...
\unrestrict 49Xbn50iUtaqUpsCqD8QJdjcXhqpAo6TxSLUMH0iCZnQqPC0Z2d2ZQfhG6woEc8
