...
\restrict uBxQJB58IYBdPVQ0SRwBc2lqpOcY0vUcwiHOl6WdmIlgIdVlh7KcLzW7MKLBfwG
...
COPY public.mountains (id, name, height, location, difficulty, created_at) FROM stdin;
\.
...
SELECT pg_catalog.setval('public.mountains_id_seq', 1, false);
...
--
-- Name: ix_mountains_name; Type: INDEX; Schema: public; Owner: postgres
--
...
\unrestrict uBxQJB58IYBdPVQ0SRwBc2lqpOcY0vUcwiHOl6WdmIlgIdVlh7KcLzW7MKLBfwG
